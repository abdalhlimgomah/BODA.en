-- Fix: IDs in frontend are taager_taager_XXXX (double prefix)
-- Re-run with correct prefix
DELETE FROM public.product_original_prices WHERE product_id LIKE 'taager\_%' AND product_id NOT LIKE 'taager\_taager\_%';

INSERT INTO public.product_original_prices (product_id, product_name, product_price, fake_original_price)
SELECT
  'taager_taager_' || tp.taager_product_id AS product_id,
