  ...
  function normalizeOrderItem(item, index) {
    ...
    return {
      ...
      selected_color_value:
        record?.selected_color_value ??
        record?.selectedColorValue ??
        record?.color_value ??
        record?.colorValue ??
        "",
      selected_size:
        ...
        record?.size ??
        null,
      selected_options: Array.isArray(record?.selected_options)
        ? record.selected_options
        : Array.isArray(record?.selectedOptions)
        ? record.selectedOptions
        : [],
      variant_label: record?.variant_label ?? record?.variantLabel ?? null,
    };
  }
